...
function defaultCardSet() {
  return [
    { id: makeId('card'), name: 'Police', value: 'Special', icon: '🕵️', type: 'police', revealed: true, locked: true },
    { id: makeId('card'), name: 'Thief', value: 0, icon: '🥷', type: 'thief', revealed: false, locked: true },
    { id: makeId('card'), name: 'King', value: 90, icon: '👑', type: 'normal', revealed: true },
    { id: makeId('card'), name: 'Minister', value: 70, icon: '🎩', type: 'normal', revealed: false },
    { id: makeId('card'), name: 'Warrior', value: 50, icon: '⚔️', type: 'normal', revealed: false },
    { id: makeId('card'), name: 'Merchant', value: 30, icon: '💰', type: 'normal', revealed: false },
    { id: makeId('card'), name: 'Joker', value: 10, icon: '🃏', type: 'normal', revealed: false },
  ];
}
